...
pub const TOKEN_CATALOG_CONTENT_DIGEST: &str =
    "fa552f15432de652c8e6f4d71297c3dbc3e2f1cf4996d5d73c98fe5a3c78bf97";
...
pub mod tokens {
    ...
    pub mod ethereum {
        ...
        pub const DISCOVERED_23A03DCF2EFBE867: &str =
        ...
        pub const DISCOVERED_4712886CEE128F13: &str =
        ...
        pub const DISCOVERED_DE17C35BF41345A6: &str =
...
pub static TOKEN_DEPLOYMENTS: &[TokenDeployment] = &[
    ...
    TokenDeployment {
        ...
        decimals: 18,
        standard: TokenStandard::Erc20,
        address: Some("0x9469d013805bffb7d3debe5e7839237e535ec483"),
        status: TokenStatus::Active,
        replaced_by_deployment_id: None,
    },
    TokenDeployment {
    ...
    TokenDeployment {
        ...
        decimals: 8,
        standard: TokenStandard::Erc20,
        address: Some("0x8400d94a5cb0fa0d041a3788e395285d61c9ee5e"),
        status: TokenStatus::Active,
        replaced_by_deployment_id: None,
    },
    TokenDeployment {
    ...
    TokenDeployment {
        ...
        decimals: 8,
        standard: TokenStandard::Erc20,
        address: Some("0xb64ef51c888972c908cfacf59b47c1afbc0ab8ac"),
        status: TokenStatus::Active,
        replaced_by_deployment_id: None,
    },
    TokenDeployment {
...
pub static TOKEN_ALIASES: &[TokenAlias] = &[
    ...
    TokenAlias {
        namespace: "ethereum",
        name: "DISCOVERED_23A03DCF2EFBE867",
        deployment_id: tokens::ethereum::DISCOVERED_23A03DCF2EFBE867,
    },
    TokenAlias {
        namespace: "ethereum",
    ...
    TokenAlias {
        namespace: "ethereum",
        name: "DISCOVERED_4712886CEE128F13",
        deployment_id: tokens::ethereum::DISCOVERED_4712886CEE128F13,
    },
    TokenAlias {
        namespace: "ethereum",
    ...
    TokenAlias {
        namespace: "ethereum",
        name: "DISCOVERED_DE17C35BF41345A6",
        deployment_id: tokens::ethereum::DISCOVERED_DE17C35BF41345A6,
    },
    TokenAlias {
        namespace: "ethereum",
